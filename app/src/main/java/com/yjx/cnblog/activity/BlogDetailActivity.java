...
public class BlogDetailActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        tv_author.setText(info.getAuthor().getName() + " 发表于" + TimeUtils.parseTime(info.getPublishedtime()));
    ...
    protected void onDestroy() {
        super.onDestroy();
        client.getRequestQueue().cancelAll("getblogdetail");
        dialog.cancel();
        if (snappydb != null) {
            try {
                snappydb.close();
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("博客正文");
    }
    ...
    private void getBlogDetail() {
        StringRequest request = new StringRequest(Request.Method.GET, Constant.BLOGDETAILURL + info.getId(), new Response.Listener<String>() {
            @Override
